  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6 text-sm">
        <a href="/prompts" className="text-indigo-600 hover:text-indigo-800 font-medium">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500 mt-1">Update your in-app feedback prompt.</p>
      </div>

      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <form action={updatePromptWithId} className="space-y-6">
          {message && (
          ...
          <div>
            ...
            <input
              className="w-full rounded-md px-4 py-2 bg-slate-50 border border-slate-200 text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              name="question_text"
              defaultValue={prompt.question_text}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                name="trigger_type"
                defaultValue={prompt.trigger_type}
                className="w-full rounded-md px-4 py-2 bg-slate-50 border border-slate-200 text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                required
              >
