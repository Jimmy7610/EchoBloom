  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatusCard title="Prompts" count={promptCount || 0} icon={<MessageSquare className="w-4 h-4" />} />
        <StatusCard title="Responses" count={responseCount || 0} icon={<Database className="w-4 h-4" />} />
        <StatusCard title="Notifications" count={notificationCount || 0} icon={<Bell className="w-4 h-4" />} />
        <StatusCard title="Insights" count={insightCount || 0} icon={<Sparkles className="w-4 h-4" />} />
      </section>
